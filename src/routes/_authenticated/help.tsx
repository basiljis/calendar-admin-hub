...
const sections: Section[] = [
  {
    ...
    steps: [
      ...
      "В шапке календаря показано количество сотрудников по группам — нажмите на группу, чтобы оставить в календаре только её.",
      "Сотрудники с одинаковым временем смены объединены в одну карточку: время, кружочки с фото и «+N».",
      ...
      "В тёмной теме завершённые смены выглядят приглушённо, но остаются зелёными.",
